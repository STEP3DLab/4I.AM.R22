...
const benefits = [
  '6 дней: 3D-сканирование → CAD → печать без пауз',
  'Практика на оборудовании STEP_3D и партнёров',
  'Поддержка экспертов WorldSkills на каждом этапе',
];
const audience = [
  'Инженеры-конструкторы и технологи',
  'Операторы ЧПУ и мастера производства',
  'Студенты техвузов, молодые учёные, преподаватели',
  'Промышленные дизайнеры и проектные команды',
];
const teamMembers = [
  {
    id: 'rekut',
